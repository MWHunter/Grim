...
import ac.rino.rinoac.utils.nmsutil.FluidTypeFlowing;
...
public class PointThreeEstimator {
    ...
    public PointThreeEstimator(RinoPlayer player) {
        this.player = player;
    }
    ...
    private double iterateGravity(RinoPlayer player, double y) {
