...
import ac.rino.rinoac.utils.nmsutil.FluidFallingAdjustedMovement;
import ac.rino.rinoac.utils.nmsutil.ReachUtils;
...
public class PredictionEngineWater extends PredictionEngine {
    ...
    public static void staticVectorEndOfTick(RinoPlayer player, Vector vector, float swimmingFriction, double playerGravity, boolean isFalling) {
    ...
    public static Set<VectorData> transformSwimmingVectors(RinoPlayer player, Set<VectorData> base) {
    ...
    public void guessBestMovement(float swimmingSpeed, RinoPlayer player, boolean isFalling, double playerGravity, float swimmingFriction, double lastY) {
    ...
    @Override
    public void endOfTick(RinoPlayer player, double playerGravity) {
