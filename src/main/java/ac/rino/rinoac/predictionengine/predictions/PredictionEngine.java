...
import ac.rino.rinoac.predictionengine.movementtick.MovementTickerPlayer;
...
import ac.rino.rinoac.utils.nmsutil.Riptide;
...
public class PredictionEngine {
    ...
    public static Vector clampMovementToHardBorder(RinoPlayer player, Vector outputVel) {
        // TODO: Reimplement
        return outputVel;
    }

    public static Vector transformInputsToVector(RinoPlayer player, Vector theoreticalInput) {
        float bestPossibleX;
        float bestPossibleZ;
    ...
    public void guessBestMovement(float speed, RinoPlayer player) {
    ...
    private void doPredictions(RinoPlayer player, List<VectorData> possibleVelocities, float speed) {
    ...
    private Pair<Vector, Vector> doSeekingWallCollisions(RinoPlayer player, Vector primaryPushMovement, Vector originalClientVel, VectorData clientVelAfterInput) {
    ...
    private void addZeroPointThreeToPossibilities(float speed, RinoPlayer player, List<VectorData> possibleVelocities) {
    ...
    public void addFluidPushingToStartingVectors(RinoPlayer player, Set<VectorData> data) {
    ...
    private void addNonEffectiveAI(RinoPlayer player, Set<VectorData> data) {
    ...
    private void addAttackSlowToPossibilities(RinoPlayer player, Set<VectorData> velocities) {
    ...
    public void applyMovementThreshold(RinoPlayer player, Set<VectorData> velocities) {
    ...
    public void addExplosionToPossibilities(RinoPlayer player, Set<VectorData> existingVelocities) {
    ...
    public int sortVectorData(VectorData a, VectorData b, RinoPlayer player) {
        int aScore = 0;
        int bScore = 0;
    ...
    public Vector handleStartingVelocityUncertainty(RinoPlayer player, VectorData vector, Vector targetVec) {
    ...
    private void loopVectors(RinoPlayer player, Set<VectorData> possibleVectors, float speed, List<VectorData> returnVectors) {
        // Stop omni-sprint
    ...
    public Vector getMovementResultFromInput(RinoPlayer player, Vector inputVector, float f, float f2) {
    ...
    public void doJump(RinoPlayer player, Vector vector) {
