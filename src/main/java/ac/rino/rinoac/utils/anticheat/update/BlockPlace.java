...
import ac.rino.rinoac.utils.collisions.AxisSelect;
import ac.rino.rinoac.utils.collisions.AxisUtil;
...
import ac.rino.rinoac.utils.data.HitData;
...
import ac.rino.rinoac.utils.nmsutil.BoundingBoxSize;
...
public class BlockPlace {
    ...
    public BlockFace getPlayerFacing() {
        return BY_2D[RinoMath.floor(player.xRot / 90.0D + 0.5D) & 3];
    }
