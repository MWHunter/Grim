...
import ac.rino.rinoac.utils.inventory.inventory.AbstractContainerMenu;
import ac.rino.rinoac.utils.inventory.slot.EquipmentSlot;
import ac.rino.rinoac.utils.inventory.slot.ResultSlot;
import ac.rino.rinoac.utils.inventory.slot.Slot;
import ac.rino.rinoac.utils.lists.CorrectingPlayerInventoryStorage;
...
public class Inventory extends AbstractContainerMenu {
    ...
    public Inventory(RinoPlayer player, CorrectingPlayerInventoryStorage inventoryStorage) {
