...
public class Slot {
    ...
    public ItemStack safeTake(int p_150648_, int p_150649_, RinoPlayer p_150650_) {
    ...
    public Optional<ItemStack> tryRemove(int p_150642_, int p_150643_, RinoPlayer p_150644_) {
    ...
    public void onTake(RinoPlayer p_150645_, ItemStack p_150646_) {

    }

    // No override
    public boolean allowModification(RinoPlayer p_150652_) {
        return this.mayPickup(p_150652_) && this.mayPlace(this.getItem());
    }

    public boolean mayPickup(RinoPlayer p_40228_) {
        return true;
    }
}
