...
public enum MenuType {
    ...
    public static AbstractContainerMenu getMenuFromID(RinoPlayer player, Inventory playerInventory, MenuType type) {
        switch (type) {
            case GENERIC_9x1:
            case GENERIC_9x2:
            case GENERIC_9x3:
    ...
    public static AbstractContainerMenu getMenuFromString(RinoPlayer player, Inventory inventory, String legacyType, int slots, int horse) {
        switch (legacyType) {
