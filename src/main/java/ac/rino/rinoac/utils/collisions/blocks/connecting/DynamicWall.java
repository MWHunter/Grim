...
public class DynamicWall extends DynamicConnecting implements CollisionFactory {
    ...
    public CollisionBox fetchRegularBox(RinoPlayer player, WrappedBlockState state, ClientVersion version, int x, int y, int z) {
    ...
    @Override
    public boolean checkCanConnect(RinoPlayer player, WrappedBlockState state, StateType one, StateType two, BlockFace direction) {
