...
public class ReachUtils {
    ...
    public static Vector getLook(RinoPlayer player, float yaw, float pitch) {
    ...
    public static double getMinReachToBox(RinoPlayer player, SimpleCollisionBox targetBox) {
