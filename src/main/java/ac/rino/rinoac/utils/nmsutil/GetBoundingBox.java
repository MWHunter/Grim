...
public class GetBoundingBox {
    public static SimpleCollisionBox getCollisionBoxForPlayer(RinoPlayer player, double centerX, double centerY, double centerZ) {
    ...
    public static SimpleCollisionBox getPacketEntityBoundingBox(RinoPlayer player, double centerX, double minY, double centerZ, PacketEntity entity) {
    ...
    public static SimpleCollisionBox getPlayerBoundingBox(RinoPlayer player, double centerX, double minY, double centerZ) {
    ...
    public static SimpleCollisionBox getBoundingBoxFromPosAndSize(RinoPlayer player, double centerX, double minY, double centerZ, float width, float height) {
