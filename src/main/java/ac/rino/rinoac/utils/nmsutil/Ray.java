...
public class Ray implements Cloneable {
    ...
    public Ray(RinoPlayer player, double x, double y, double z, float xRot, float yRot) {
    ...
    public static Vector calculateDirection(RinoPlayer player, float xRot, float yRot) {
