...
import ac.rino.rinoac.utils.data.packetentity.PacketEntitySizeable;
...
public final class BoundingBoxSize {
    ...
    public static float getWidth(RinoPlayer player, PacketEntity packetEntity) {
    ...
    private static float getWidthMinusBaby(RinoPlayer player, PacketEntity packetEntity) {
    ...
    public static Vector3d getRidingOffsetFromVehicle(PacketEntity entity, RinoPlayer player) {
    ...
    public static float getHeight(RinoPlayer player, PacketEntity packetEntity) {
        // Turtles are the only baby animal that don't follow the * 0.5 rule
    ...
    public static double getPassengerRidingOffset(RinoPlayer player, PacketEntity packetEntity) {
