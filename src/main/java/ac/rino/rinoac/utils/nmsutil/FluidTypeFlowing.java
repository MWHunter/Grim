...
import ac.rino.rinoac.utils.collisions.blocks.DoorHandler;
...
public class FluidTypeFlowing {
    public static Vector getFlow(RinoPlayer player, int originalX, int originalY, int originalZ) {
    ...
    private static boolean affectsFlow(RinoPlayer player, int originalX, int originalY, int originalZ, int x2, int y2, int z2) {
        return isEmpty(player, x2, y2, z2) || isSame(player, originalX, originalY, originalZ, x2, y2, z2);
    }

    protected static boolean isSolidFace(RinoPlayer player, int originalX, int y, int originalZ, BlockFace direction) {
    ...
    public static boolean isEmpty(RinoPlayer player, int x, int y, int z) {
    ...
    public static boolean isSame(RinoPlayer player, int x1, int y1, int z1, int x2, int y2, int z2) {
