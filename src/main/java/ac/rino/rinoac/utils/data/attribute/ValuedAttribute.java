package ac.rino.rinoac.utils.data.attribute;
...
import static ac.rino.rinoac.utils.latency.CompensatedEntities.SPRINTING_MODIFIER_UUID;
...
public final class ValuedAttribute {
     ...
     */
    public ValuedAttribute requiredVersion(RinoPlayer player, ClientVersion requiredVersion) {
    ...
    public double with(WrapperPlayServerUpdateAttributes.Property property) {
        ...
        double newValue = RinoMath.clampFloat((float) d1, (float) min, (float) max);
        if (setRewriter != null) {
