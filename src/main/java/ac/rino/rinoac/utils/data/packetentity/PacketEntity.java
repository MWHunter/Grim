// This file was designed and is an original check for RinoAC
...
import ac.rino.rinoac.utils.data.ReachInterpolationData;
import ac.rino.rinoac.utils.data.TrackedPosition;
...
public class PacketEntity extends TypedPacketEntity {
    ...
    public PacketEntity(RinoPlayer player, UUID uuid, EntityType type, double x, double y, double z) {
        super(type);
        this.uuid = uuid;
        initAttributes(player);
        this.trackedServerPosition = new TrackedPosition();
