...
public class PacketWorldReaderEight extends BasePacketWorldReader {
    @Override
    public void handleMapChunkBulk(final RinoPlayer player, final PacketSendEvent event) {
    ...
    @Override
    public void handleMapChunk(final RinoPlayer player, final PacketSendEvent event) {
        PacketWrapper wrapper = new PacketWrapper(event);
