...
import ac.rino.rinoac.checks.impl.badpackets.BadPacketsE;
import ac.rino.rinoac.checks.impl.badpackets.BadPacketsF;
import ac.rino.rinoac.player.RinoPlayer;
import ac.rino.rinoac.utils.data.TrackerData;
...
public class PacketPlayerRespawn extends PacketListenerAbstract {
    ...
    private boolean isWorldChange(RinoPlayer player, WrapperPlayServerRespawn respawn) {
