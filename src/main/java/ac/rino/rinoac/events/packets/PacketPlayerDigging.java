...
import ac.rino.rinoac.checks.impl.movement.NoSlowA;
import ac.rino.rinoac.checks.impl.movement.NoSlowD;
...
public class PacketPlayerDigging extends PacketListenerAbstract {
    ...
    public static void handleUseItem(RinoPlayer player, ItemStack item, InteractionHand hand) {
        if (item == null) {
    ...
    public void onPacketReceive(PacketReceiveEvent event) {
        if (event.getPacketType() == PacketType.Play.Client.PLAYER_DIGGING) {
            ...
            if (dig.getAction() == DiggingAction.RELEASE_USE_ITEM) {
                final RinoPlayer player = RinoAPI.INSTANCE.getPlayerDataManager().getPlayer(event.getUser());
