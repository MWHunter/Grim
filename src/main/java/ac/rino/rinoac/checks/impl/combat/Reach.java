...
package ac.rino.rinoac.checks.impl.combat;
...
import ac.rino.rinoac.utils.data.packetentity.dragon.PacketEntityEnderDragonPart;
...
public class Reach extends Check implements PacketCheck {
    ...
    public Reach(RinoPlayer player) {
        super(player);
    }
