...
import ac.rino.rinoac.utils.nmsutil.BlockBreakSpeed;
...
public class FastBreak extends Check implements PacketCheck {
    ...
    private void clampBalance() {
        ...
        blockBreakBalance = RinoMath.clamp(blockBreakBalance, -balance, balance); // Clamp not Math.max in case other logic changes
        blockDelayBalance = RinoMath.clamp(blockDelayBalance, -balance, balance);
    }
}
